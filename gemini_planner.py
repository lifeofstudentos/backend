  ...
  "plan_adjustment": "how to modify today's plan"
    ...
    try:
        ...
        return ConfusionResponse(
            calm_response="I understand you're feeling overwhelmed. Let's break this down together.",
            action_items=["Take a 5-minute break", "List your top 3 priorities", "Start with the easiest task"],
            plan_adjustment="Focus on one task at a time today"
        )
